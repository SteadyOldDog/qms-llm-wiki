...
Write-Host "=== 1. 同步 Wiki 文件 ===" -ForegroundColor Cyan
...
Write-Host "`n=== 2. 重建网站 ===" -ForegroundColor Cyan
cd $site
...
Write-Host "`n=== 3. 部署到 Cloudflare Pages ===" -ForegroundColor Cyan
wrangler pages deploy site --project-name=qms-llm-wiki --commit-dirty=true 2>&1

if ($LASTEXITCODE -eq 0) {
    Write-Host "`n✅ 部署完成！" -ForegroundColor Green
    Write-Host "网站地址: https://qms-llm-wiki.pages.dev/" -ForegroundColor Yellow
} else {
